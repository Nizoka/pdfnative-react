---
description: "Use when writing tests, extending coverage, regenerating samples, the byte baseline or the conformance corpus, or debugging failures for pdfnative-react."
applyTo: "tests/**,scripts/**,samples/**"
---
# Testing Standards
